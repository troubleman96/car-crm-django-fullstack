"""
Mock AI chatbot response engine.

Replace this function with a real LLM call later --
same input/output signature.

Takes a user message string and returns a reply string.
Uses simple keyword matching for the student project.
"""
